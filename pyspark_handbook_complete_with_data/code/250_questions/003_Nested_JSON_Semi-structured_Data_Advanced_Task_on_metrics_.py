"""
Question 3: Nested JSON & Semi-structured Data: Advanced Task on `metrics`
...
result = items.select("user_id", "updated_at", F.col("it.sku").alias("sku"), F.col(f"it.amount").alias("amount"))
