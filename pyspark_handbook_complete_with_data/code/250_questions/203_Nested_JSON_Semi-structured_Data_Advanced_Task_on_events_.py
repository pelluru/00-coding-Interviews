"""
Question 203: Nested JSON & Semi-structured Data: Advanced Task on `events`
...
result = items.select("session_id", "created_at", F.col("it.sku").alias("sku"), F.col(f"it.duration_ms").alias("duration_ms"))
