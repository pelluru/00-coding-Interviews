"""
Question 153: Nested JSON & Semi-structured Data: Advanced Task on `orders`
...
result = items.select("account_id", "updated_at", F.col("it.sku").alias("sku"), F.col(f"it.duration_ms").alias("duration_ms"))
