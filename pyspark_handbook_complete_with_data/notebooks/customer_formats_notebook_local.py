...
# MAGIC %md
# MAGIC # Customer I/O Formats Pack (Local Paths)
# MAGIC Uses a BASE_PATH widget to set dataset location. Defaults baked in.
# COMMAND ----------
dbutils.widgets.text("BASE_PATH", "/dbfs/mnt/data/customer_demo_data", "Dataset Base Path")
BASE_PATH = dbutils.widgets.get("BASE_PATH")
print("BASE_PATH:", BASE_PATH)
# COMMAND ----------
# MAGIC %md
# MAGIC ## 01_json_customers_explicit_schema_local.py
# COMMAND ----------
"""
...
# COMMAND ----------
# MAGIC %md
# MAGIC ## 02_json_nested_multiline_explode_local.py
# COMMAND ----------
"""
Customer I/O Formats Pack — Pure PySpark Examples
...
raw = (spark.read
       ...
       .schema(schema)
       .json("/mnt/data/customer_demo_data/customers_orders.json"))
...
# COMMAND ----------
# MAGIC %md
# MAGIC ## 03_csv_customers_options_local.py
# COMMAND ----------
"""
Customer I/O Formats Pack — Pure PySpark Examples
...
df = (spark.read
      ...
      .schema(schema)
      .csv("/mnt/data/customer_demo_data/customers.csv"))
...
# COMMAND ----------
# MAGIC %md
# MAGIC ## 04_parquet_partition_pruning_local.py
# COMMAND ----------
"""
Customer I/O Formats Pack — Pure PySpark Examples
...
df = spark.read.parquet("/mnt/data/customer_demo_data/customers_parquet/")  # e.g., .../country=US/yr=2025/mo=10/
...
# COMMAND ----------
# MAGIC %md
# MAGIC ## 05_parquet_schema_evolution_local.py
# COMMAND ----------
"""
Customer I/O Formats Pack — Pure PySpark Examples
...
base.write.mode("overwrite").parquet("/mnt/data/customer_demo_data/customers_evo")
extra.write.mode("append").parquet("/mnt/data/customer_demo_data/customers_evo")  # different schema

merged = (spark.read
          .option("mergeSchema","true")
          .parquet("/mnt/data/customer_demo_data/customers_evo"))
merged.printSchema()
merged.show()

# COMMAND ----------
# MAGIC %md
# MAGIC ## 06_upsert_foreachBatch_local.py
# COMMAND ----------
"""
Customer I/O Formats Pack — Pure PySpark Examples
...
# COMMAND ----------
# MAGIC %md
# MAGIC ## 07_xml_customers_basic_local.py
# COMMAND ----------
"""
Customer I/O Formats Pack — Pure PySpark Examples
...
df = (spark.read
      ...
      .load("/mnt/data/customer_demo_data/customers.xml"))
...
# COMMAND ----------
# MAGIC %md
# MAGIC ## 08_xml_customers_nested_local.py
# COMMAND ----------
"""
Customer I/O Formats Pack — Pure PySpark Examples
...
df = (spark.read.format("xml")
      .option("rowTag","customer")
      .load("/mnt/data/customer_demo_data/customers_nested.xml"))
...
# COMMAND ----------
# MAGIC %md
# MAGIC ## 09_csv_vs_parquet_perf_local.py
# COMMAND ----------
"""
Customer I/O Formats Pack — Pure PySpark Examples
...
# COMMAND ----------
# MAGIC %md
# MAGIC ## 10_jsonlines_customers_local.py
# COMMAND ----------
"""
Customer I/O Formats Pack — Pure PySpark Examples
...
# COMMAND ----------
# MAGIC %md
# MAGIC ## customer_formats_notebook_local.py
# COMMAND ----------
# Databricks notebook source
# MAGIC %md
